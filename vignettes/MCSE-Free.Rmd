...
By twenty years later, biostatisticians' had completed their retreat to offices hermetically sealed against intrusion of clinical collaborations, viewing computer-based model tuning activities as "the main challenge when using the CRM" [@lee_calibration_2011].

# On *calibration*

It is interesting to see that the term 'tuning' employed by ... has become 'calibration' 
