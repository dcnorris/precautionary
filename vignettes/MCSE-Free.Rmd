...
These dose recommendations must be weighted by the path probabilities of some chosen dose-toxicity scenario. For sake of an easy demonstration, let's take our scenario from the skeleton itself:

```{r pcs}
pi_skel <- exp(log_pi(prob.DLT = c(0.03, 0.11, 0.25, 0.42, 0.58, 0.71)))
options(digits=4)
