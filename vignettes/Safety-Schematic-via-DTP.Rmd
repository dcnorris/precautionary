...
TODO: Generalize the above calculation to a $\kappa$-trellised grid of $(\sigma, \kappa)$ centered on the skeleton. This will help to place the skeleton (and scenarios thereof) within a larger context of hyperpriors. Our skeleton fit might indeed be marked with an 'x' in these grids, to accentuate this concept.
