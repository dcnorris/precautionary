...
rel_r0 <- seq(0.5, 1.2, 0.1) # relative to rho **on the dB scale**
...
fataltab[, `:=`(
  rel_r0 = ordered(paste("r0[dB]/rho[dB] =", round(as.numeric(rel_r0),2)))
...
contourplot(value ~ MTD_median + rel_SDlog | rel_r0
            ...
            , ylab = list(expression(frac(sigma[dB], rho[dB])), rot=0)
