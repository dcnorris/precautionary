...
$$
f_d = \frac{P_{\mu,\CV}(\MTDi <  r_0^2 D_d)}{P_{\mu,\CV}(\MTDi < D_d)},
$$
...
Having calculated the $J$-vectors $\mathbf{b}_D$ and $(J \time 2D)$ matrices $\mathrm{U}_D$, we now have to demonstrate that Equations \@ref(eq:logpi)--\@ref(eq:fatalities) yield results consistent with simulation studies. This comparison should also gauge the speedup achieved through this rather large amount of effort!
