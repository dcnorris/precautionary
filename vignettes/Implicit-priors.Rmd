...
# 
rho <- exp(seq(log(1.3), log(2.0), length.out = 8))
rel_r0 <- seq(0.5, 1.2, 0.1)
MTD_median <- seq(1, D, 0.25) # express dose on scale of dose number 1--D (fractions ok!)
rel_SDlog <- seq(0.5, 1.5, 0.1) # TODO: Better scaled relative to rho, r0, or both?
F <- array(dim = sapply(list(rel_r0, rho, MTD_median, rel_SDlog), length),
