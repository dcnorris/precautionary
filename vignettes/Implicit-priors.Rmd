...
$$
\log \boldsymbol{\pi} = \sum_{c,d} \log {3 \choose T_{c,d}} + \sum_c [T_{c,d},3-T_{c,d}]\left[{ \log \mathbf{p} \atop \log \mathbf{q}} \right] = \mathbf{b}_D + U_D\left[{ \log \mathbf{p} \atop \log \mathbf{q}} \right].
$$
...
$$
\boldsymbol{\pi}^\intercal \mathrm{Y} \mathbf{f}.
$$
