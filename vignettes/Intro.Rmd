...
design %>% simulate_trials(
  num_sims = c(M = 20 # Number of trials to simulate per hyperprior draw
              ,K = 20 # Number of draws from hyperprior
              )
...
What about our uncertainty over the parameter $r_0$?
deiayou never know where they will stop. Discuss prior elicitation.

Here, introduce the `mtdi_generator` idea.
