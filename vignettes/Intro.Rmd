...
Judging from Table \@ref(tab:MTDi-regime), however, introducing the MTD$_i$ concept alone has so far generated little progress. The only apparent difference compared with Table \@ref(tab:basic-sim) is the addition of a column with *actual* doses. To make further progress *operating within the dose-escalation paradigm*, we need to introduce another concept.
